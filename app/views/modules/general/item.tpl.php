<table summary="General Course Info" class="nested_table" cellpadding="0" cellspacing="0" style="border-top: 1px solid #aaa;">
    <tr>
        <td class="table_padder">
            <a href="syllabus/edit_info/{$syllabus.syllabus_id}" class="colorbox icon">
                <span class="icon edit inline-block"></span> Edit Course Information
            </a>        
        </td>
        <td>&nbsp;</td>
    </tr>

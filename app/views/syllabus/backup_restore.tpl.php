...
<ul id="syllabus_backup_restore" class="tabs">
    <li id="tab_backup"><a href="{$smarty.const.CURRENT_URL}#tabcontent-backup"><strong>Backup</strong></a></li>
    <li id="tab_restore"><a href="{$smarty.const.CURRENT_URL}#tabcontent-restore"><strong>Restore</strong></a></li>
</ul>

...
<header class="at">
	    <nav class="navbar navbar-light flex-md-nowrap ">
	      	<a class="navbar-brand col-sm-3 col-md-2 bg-light" href="{$baseUrl}">
	      		<img src="assets/images/AT-Syllabus-Icon-600x403-20pxBorder.png" height="35" class="d-inline-block align-middle pr-1" alt="Syllabus Logo">
	      		Syllabus
	  		</a>
...
<div class="container-fluid">
	<div class="row">
          ...
          <div class="sidebar-sticky">
              ...
              <li class="nav-item">
                <a class="nav-link" href="syllabus/new">
		            <h6 class="sidebar-heading d-flex justify-content-between align-items-center mt-4 mb-1 text-muted">
		              <span><i class="fas fa-file-alt pr-2"></i> My Syllabi</span>
		            </h6>
                </a>
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link" href="syllabus/new">
		            <h6 class="sidebar-heading d-flex justify-content-between align-items-center mt-4 mb-1 text-muted">
		              <span><i class="fas fa-school pr-2"></i> My Groups</span>
		            </h6>
                </a>
				<ul class="nav flex-column pl-3">
	              <li class="nav-item">
		...
		{if $headerPartial}
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-3 mt-0" id="mainContent">
			{include file=$headerPartial headerVars=$headerVars}
		{else}
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-3 mt-3" id="mainContent">
		{/if}
			<!-- MAIN CONTENT -->

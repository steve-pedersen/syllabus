...
<!-- Preview Modal -->
<div class="modal fade" id="sloModal" tabindex="-1" role="dialog" aria-labelledby="sloTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg modal-sm" role="document">
    <div class="modal-content">
	<div class="modal-header">
		<h5 class="modal-title" id="sloTitle">Coming Soon: Student Learning Outcomes</h5>
	...
	<div class="modal-body">
		<p>
			The Student Learning Outcomes section type will be coming to the Syllabus application soon. In the meantime, users are advised to use the Objectives section type instead.
		</p>
		<p>
			The upcoming Student Learning Outcomes section type will automatically populate the section with official SLOs data for your course.
		</p>
	</div>

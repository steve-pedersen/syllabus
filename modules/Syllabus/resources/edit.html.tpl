...
<div class="syllabus-editor mt-3" id="syllabusEditor">
			...
			<a class="d-block bg-light p-2 section-collapse-link" data-toggle="collapse" href="#metadataCollapse" role="button" aria-expanded="false" aria-controls="metadataCollapse">			
				<div class="text-left d-inline-block" id="metadataHeading"> 
					<span class="mb-0 section-title">
						<strong>Syllabus Metadata</strong><small><i class="fas fa-chevron-down text-dark pl-2"></i></small>
					</span>
	...
	<div class="sort-container">
		...
		{elseif $syllabus->inDataSource && $realSection}
			...
			<div class="editor-{$extName} border border-warning active-section-editor rounded-0 p-1 mt-3" id="section{$extName}Edit">
			        ...
			        <div class="form-group row">
			            ...
			            <div class="col-lg-9">
							<div class="d-flex">
				                ...
				                <a href="{$smarty.server.REQUEST_URI}" class="btn btn-outline-secondary">Cancel</a>

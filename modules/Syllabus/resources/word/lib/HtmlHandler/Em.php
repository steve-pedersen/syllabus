...
/**
 * Handle 'em' tags in html.  The word document should implement
 * a style called 'Emphasis' to style 'em' tags.
 * 
 * @author	Charles O'Sullivan (chsoney@sfsu.edu)
 * @copyright	Copyright &copy; San Francisco State University.
 */
class WordDocHtmlHandlerEm extends WordDocHtmlHandler
{
	/**

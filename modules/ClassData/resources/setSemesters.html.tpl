...
<p>
    ...
    YYYS where YYY is the year without a zero, e.g. 2019 is 219, and 
    S is 1 for Winter, 2 for Spring, 3 for Summer, and 4 for Fall.
</p>

<form method="post" action="">
    <div class="field">
        <label for="set-semesters" class="field-label">Semesters (comma-separated values of form <samp>YYYS</samp>)</label>

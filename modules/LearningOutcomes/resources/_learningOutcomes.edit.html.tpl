    ...
    <div class="row sort-item">
        <div class="tab-content col-11 px-0" id="toggleEditViewTab{$i}">
            <div class="tab-pane fade border" id="nav-edit-{$i}" role="tabpanel" aria-labelledby="nav-edit-{$i}-tab">
                ...
                <input type="hidden" name="section[real][{$learningOutcomeId}][sortOrder]" value="{$i+1}" class="sort-order-value" id="form-field-{$i+1}-sort-order">
                
                <div class="d-flex justify-content-between">
                    <label class="form-control-label px-2 row-label">Row #{$i + 1}</label>
                    <button type="submit" aria-label="Delete" class="btn btn-link text-danger my-0 mx-2" name="command[deletesectionitem][Syllabus_LearningOutcomes_LearningOutcome][{$learningOutcomeId}]" id="{$learningOutcomeId}">

<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#policiesImportModal">
    <i class="fas fa-file-import mr-2"></i> Import Objectives Content
</button>
...
<div class="modal fade" id="policiesImportModal" tabindex="-1" role="dialog" aria-labelledby="importTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl " role="document">
    ...
    <div class="modal-body">
        ...
        <p class="lead">
            <strong>Note, the following content will be added in addition to your current content and will NOT replace any of your work.</strong> Select the content to add to your syllabus. You are able to view, edit, or remove the full content once it has been added to your syllabus.
        </p>

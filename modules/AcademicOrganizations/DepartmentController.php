...
class Syllabus_AcademicOrganizations_DepartmentController extends Syllabus_Organizations_BaseController
{
    public static function getRouteMap ()
    {
        return [
            ...
            '/departments/:oid/submissions'    => ['callback' => 'manageSubmissions', ':oid' => '[0-9]+'],
            '/departments/:oid/submissions/:sid' => ['callback' => 'editSubmission', ':oid' => '[0-9]+'],
            '/departments/:oid/campaigns/:cid' => ['callback' => 'editCampaign', ':oid' => '[0-9]+|new'],
